...
- conditions：**条件化预判核心（必须非空，2-3 条）**，每条包含
  ...
  文本精简要求（2026-09-02）：condition 与 scenario 一律用关键词式短语（如 "板块放量站稳 10 日线"、"回踩 60 日线不破"），禁止长句/多从句/背景铺垫堆砌（幅度与阈值仍须量化保留）。
  关键词长度约束（2026-09-02）：condition 拆为 1~2 个关键词短语，单条不超过 10 字（硬上限 15 字），如 "两市放量≥2.2万亿"。
